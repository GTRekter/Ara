...
--
-- Host: localhost
-- Generation Time: Jul 22, 2015 at 10:16 AM
...
CREATE TABLE `subcategory` (
  ...
  `nameSubcategory` varchar(120) NOT NULL,
  `nameSubcategory_en` varchar(120) NOT NULL,
  `nameSubcategory_es` varchar(120) NOT NULL,
  `nameSubcategory_fr` varchar(120) NOT NULL,
  `nameSubcategory_ru` varchar(120) NOT NULL,
...
(6, 1, 'gonne', '0', '0', '0', '0'),
(7, 1, 'leggins', '0', '0', '0', '0'),
(8, 1, 'swim wear', '0', '0', '0', '0'),
(9, 1, 'knit wear', '0', '0', '0', '0'),
(10, 2, 'stivali', '0', '0', '0', '0'),
(11, 2, 'flats', '0', '0', '0', '0'),
(12, 2, 'sandali', '0', '0', '0', '0'),
(13, 2, 'sneakers', '0', '0', '0', '0'),
(14, 4, 'cinture', '0', '0', '0', '0'),
(15, 4, 'cappelli', '0', '0', '0', '0'),
(16, 4, 'gioielli', '0', '0', '0', '0'),
(17, 4, 'purses', '0', '0', '0', '0'),
(18, 5, 'occhi', '0', '0', '0', '0'),
(19, 5, 'faccia', '0', '0', '0', '0'),
(20, 5, 'labbra', '0', '0', '0', '0');
