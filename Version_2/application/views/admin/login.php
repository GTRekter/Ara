...
<html>
  <head>
    ...
    <!-- iCheck -->
    <link href="<?php echo $resources_path ?>/plugins/iCheck/square/blue.css" rel="stylesheet" type="text/css" />
  ...
  <body class="login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        <p class="login-box-msg">Inserisci le tue credenziali per accedere all'area amministrativa</p>
        <form action="<?php echo site_url('front/autenticate') ?>" method="post">
		...
		<br />
		<a href="<?php echo site_url('front') ?>">Torna alla Homepage</a>
      </div><!-- /.login-box-body -->
    </div><!-- /.login-box -->
